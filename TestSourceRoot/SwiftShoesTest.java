...
import coolGame.model.item.SwiftShoes;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

/**
 * Unit testing of the SwiftShoes class
 */
public class SwiftShoesTest {
    SwiftShoes ss;
    Item item;
    Player p;

    /**
     * Initializes SwiftShoes with item and sets the hp, armor, resistances, and dodge of the player before testing
     */
    @BeforeEach
    public void setUp() {
        ss = new SwiftShoes(item);
        ...
        p.getMyStats().setDodge(10);
    }

    /**
     * Player stats (hp, armor, resistances, dodge) should be added with the minimum random int generated from the item stats
     */
    @Test
    public void testUpdatePlayerStats() {
        ...
        Assertions.assertTrue(p.getMyStats().getDodge() == 35, "Item stats should be added to dodge");
    }
